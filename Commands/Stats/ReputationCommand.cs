...
public sealed class ReputationCommand
{
    [Command("reputation")]
    [CommandAlias("rep")]
        ...
        IServiceProvider serviceProvider) : UnturnedCommand(serviceProvider)
    {
        ...
        protected override async UniTask OnExecuteAsync()
        {
            ...
            await PrintAsync(m_StringLocalizer["reputation_command:add:succeed:somebody:executor", new
            {
                PlayerName = targetSPlayer.playerID.playerName,
                CharacterName = targetSPlayer.playerID.characterName,
                NickName = targetSPlayer.playerID.nickName,
        ...
        IServiceProvider serviceProvider) : UnturnedCommand(serviceProvider)
    {
        ...
        protected override async UniTask OnExecuteAsync()
        {
            ...
            await PrintAsync(m_StringLocalizer["reputation_command:set:succeed:somebody:executor", new
            {
                PlayerName = targetSPlayer.playerID.playerName,
                CharacterName = targetSPlayer.playerID.characterName,
                NickName = targetSPlayer.playerID.nickName,
        ...
        IServiceProvider serviceProvider) : UnturnedCommand(serviceProvider)
    {
        ...
        protected override async UniTask OnExecuteAsync()
        {
            ...
            await PrintAsync(m_StringLocalizer["reputation_command:take:succeed:somebody:executor", new
            {
                PlayerName = targetSPlayer.playerID.playerName,
                CharacterName = targetSPlayer.playerID.characterName,
                NickName = targetSPlayer.playerID.nickName,
        ...
        IServiceProvider serviceProvider) : UnturnedCommand(serviceProvider)
    {
        ...
        protected override async UniTask OnExecuteAsync()
        {
            ...
            CSteamID steamID = sPlayer.playerID.steamID;
            await PrintAsync(string.Format("{0}{1}", m_StringLocalizer["reputation_command:prefix"],
        ...
        IServiceProvider serviceProvider) : UnturnedCommand(serviceProvider)
    {
        ...
        protected override async UniTask OnExecuteAsync()
        {
            ...
            SteamPlayer sPlayer = user.Player.SteamPlayer;
            CSteamID steamID = sPlayer.playerID.steamID;
            await PrintAsync(m_StringLocalizer["reputation_command:get:somebody", new
            {
                PlayerName = sPlayer.playerID.playerName,
                CharacterName = sPlayer.playerID.characterName,
                NickName = sPlayer.playerID.nickName,
