        ...
        public class SwitchUnturned : UnturnedCommand
        {
            ...
            protected override async UniTask OnExecuteAsync()
            {
                ...
                if (Context.Parameters.Length == 0)
                {
                    ...
                    PrintAsync(string.Format("{0}{1}", m_StringLocalizer["fly_command:prefix"],
                ...
                targetUser.PrintMessageAsync(string.Format("{0}{1}", m_StringLocalizer["fly_command:prefix"],
        ...
        public class SwitchConsole : UnturnedCommand
        {
            ...
            protected override async UniTask OnExecuteAsync()
            {
                ...
                if (result)
                    ...
                    m_FlySystem.EnableFlyMode(sPlayer);
                user.PrintMessageAsync(string.Format("{0}{1}", m_StringLocalizer["fly_command:prefix"],
